...
//
//        Stack<NodoMVias<K, V>> pilaDeAncestros = new Stack<>();
//        NodoMVias<K, V> nodoDeLaClave = this.buscarNodoDeLaClave(claveAEliminar, pilaDeAncestros);
//
//        if (NodoMVias.esNodoVacio(nodoDeLaClave)) {
//            return null;
//        }
//
//        int posicionDeClave = this.obtenerPosicionDeClave(nodoDeLaClave, claveAEliminar);
//        V valorAsociado = nodoDeLaClave.getValor(posicionDeClave);
//
//        if (nodoDeLaClave.esHoja()) {
//            eliminarClaveDePosicion(nodoDeLaClave, posicionDeClave);
...
//                    }
//                } else {
//                    prestarseOFuisionar(nodoDeLaClave, pilaDeAncestros);
//
//                }
//            }
//        } else {// clave esta en un nodo que no es una hojas 
//            NodoMVias<K, V> nodoDelPredecesor = this.obtenerNodoDelPredecesor(nodoDeLaClave.getHijo(posicionDeClave), pilaDeAncestros);
//            K clavePredecesora = nodoDelPredecesor.getClave(nodoDelPredecesor.nroDeClavesNoVacias() - 1);
//            V valorDelPredecesora = nodoDelPredecesor.getValor(nodoDelPredecesor.nroDeClavesNoVacias() - 1);
//
//            super.eliminarClaveDePosicion(nodoDelPredecesor, nodoDelPredecesor.nroDeClavesNoVacias() - 1);
//            nodoDeLaClave.setClave(clavePredecesora, posicionDeClave );
//            nodoDeLaClave.setValor( posicionDeClave , valorDelPredecesora);
//            
//            if (nodoDelPredecesor.nroDeClavesNoVacias() < this.nroMinDeDatos) {
//                prestarseOFusionar(nroDelPredecesor, pilaDeAncestros);
//            }
//
//        }
//
